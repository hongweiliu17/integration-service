...
func GetRequiredIntegrationTestScenariosForApplication(adapterClient client.Client, ctx context.Context, application *applicationapiv1alpha1.Application) (*[]v2alpha1.IntegrationTestScenario, error) {
	integrationList := &v2alpha1.IntegrationTestScenarioList{}
...
func GetAllIntegrationTestScenariosForApplication(adapterClient client.Client, ctx context.Context, application *applicationapiv1alpha1.Application) (*[]v2alpha1.IntegrationTestScenario, error) {
	integrationList := &v2alpha1.IntegrationTestScenarioList{}
...
func GetAllPipelineRunsForSnapshotAndScenario(adapterClient client.Client, ctx context.Context, snapshot *applicationapiv1alpha1.Snapshot, integrationTestScenario *v2alpha1.IntegrationTestScenario) (*[]tektonv1beta1.PipelineRun, error) {
...
// associated Snapshot and IntegrationTestScenario. In the case the List operation fails,
// an error will be returned.
func GetLatestPipelineRunForSnapshotAndScenario(adapterClient client.Client, ctx context.Context, snapshot *applicationapiv1alpha1.Snapshot, integrationTestScenario *v2alpha1.IntegrationTestScenario) (*tektonv1beta1.PipelineRun, error) {
