...
func NewIntegrationPipelineRun(prefix, namespace string, integrationTestScenario v2alpha1.IntegrationTestScenario) *IntegrationPipelineRun {
		...
		Spec: tektonv1beta1.PipelineRunSpec{
			PipelineRef: &tektonv1beta1.PipelineRef{
				ResolverRef: tektonv1beta1.ResolverRef{
					// 388 need to handle integrationTestScenario.Spec.ResolverRef.Resolver
					Resolver: "git",
					// 388 need to handle integrationTestScenario.Spec.ResolverRef.Params
...
func (r *IntegrationPipelineRun) WithExtraParams(params []v2alpha1.PipelineParameter) *IntegrationPipelineRun {
...
func (r *IntegrationPipelineRun) WithIntegrationLabels(integrationTestScenario *v2alpha1.IntegrationTestScenario) *IntegrationPipelineRun {
	if r.ObjectMeta.Labels == nil {
		r.ObjectMeta.Labels = map[string]string{}
	}
