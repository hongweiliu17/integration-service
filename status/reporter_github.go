...
func (r *GitHubReporter) Detect(object metav1.Object) bool {
	return metadata.HasAnnotationWithValue(object, gitops.PipelineAsCodeGitProviderAnnotation, gitops.PipelineAsCodeGitHubProviderType) ||
		...
		metadata.HasAnnotationWithValue(object, tekton.PipelineAsCodeGitProviderAnnotation, gitops.PipelineAsCodeGitHubProviderType) ||
		metadata.HasLabelWithValue(object, tekton.PipelineAsCodeGitProviderLabel, gitops.PipelineAsCodeGitHubProviderType)
}
