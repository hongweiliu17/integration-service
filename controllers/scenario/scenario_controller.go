...
func (r *Reconciler) getApplicationFromScenario(context context.Context, scenario *v2alpha1.IntegrationTestScenario) (*applicationapiv1alpha1.Application, error) {
...
func setupControllerWithManager(manager ctrl.Manager, reconciler *Reconciler) error {
	...
	return ctrl.NewControllerManagedBy(manager).
		For(&v2alpha1.IntegrationTestScenario{}).
