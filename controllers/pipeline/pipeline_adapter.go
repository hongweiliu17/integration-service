...
func (a *Adapter) getAllPipelineRunsForSnapshot(snapshot *applicationapiv1alpha1.Snapshot, integrationTestScenarios *[]v2alpha1.IntegrationTestScenario) (*[]tektonv1beta1.PipelineRun, error) {
